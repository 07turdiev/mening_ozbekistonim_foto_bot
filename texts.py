...
RULES = (
    ...
    f"(vertikal kadr uchun {cfg.min_height} × {cfg.min_width}; yuqori chegara yo‘q)\n"
...
HOW_TO_SEND = (
    ...
    "<b>Talablar:</b>\n"
    "• format — JPG / JPEG\n"
    f"• o‘lcham — uzun tomoni kamida {max(cfg.min_width, cfg.min_height)}, "
    f"qisqa tomoni kamida {min(cfg.min_width, cfg.min_height)} piksel\n"
    "  <i>(gorizontal ham, vertikal kadr ham bo‘laveradi; yuqori chegara yo‘q)</i>\n"
